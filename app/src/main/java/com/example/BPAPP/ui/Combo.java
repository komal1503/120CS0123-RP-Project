    ...
    import com.example.BPAPP.ui.scgCopy;
...
//            setContentView(R.layout.combo);
//
//            // Initialize PpgFrameProcessor
//            ppgFrameProcessor = new PpgFrameProcessor(this, new WeakReference<>(null), new WeakReference<>(this));
//
//            initPpgComponents();
//            // Initialize ScgActivity components
////            initScgComponents();
//            // Initialize PpgActivity components
//
//
//        }
//
//        private void initPpgComponents() {
//            // Start PpgActivity by intent
//            Intent ppgIntent = new Intent(this, PpgActivity.class);
//            startActivity(ppgIntent);
//        }
//
//        private void initScgComponents() {
//            // Start ScgActivity by intent
//            Intent scgIntent = new Intent(this, ScgActivity.class);
//            startActivity(scgIntent);
//        }
//
//        @Override
//        protected void onResume() {
...
//        public void onDataPointAdded(long timestamp, int redSum) {
//            // Handle data point added event
//            // Delegate the handling to PpgFrameProcessor
//    //        ppgFrameProcessor.onDataPointAdded(timestamp, redSum);
//        }
//
//        // Add other methods and logic as needed
//    }
