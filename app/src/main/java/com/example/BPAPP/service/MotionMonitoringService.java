...
import static com.example.BPAPP.constant.GlobalConstants.MEASUREMENT_PHASE_CHANGE;
...
public class MotionMonitoringService extends Service {
    ...
    private void listenToSensor() {
        if (acceleration != null) {
            motionListener = new com.example.BPAPP.service.MotionListener(() -> Toast.makeText(this, R.string.toast_keep_device_still, Toast.LENGTH_SHORT).show());
    ...
    public class PhaseChangedBroadcast extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (message != null) {
                ...
                if (com.example.BPAPP.service.MeasurementPhase.valueOf(message) == com.example.BPAPP.service.MeasurementPhase.START) {
                    listenToSensor();
                } else {
                    stopSensorListener();
                }
